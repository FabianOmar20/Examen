...
.success h2 {
  ...
  <div class="content">
    ...
    <div class="bridge">
      <div class="title">Fabian  Omar Granados Paulin</div>
      <div class="slogan">lo bucas lo tenemos!</div>
    </div>
    <div class="nav">
      <ul>
        <li><a href="/">Investigacion1</a> | </li>
        <li><a href="/conocimiento">Investigacion2</a> | </li>
        <li><a href="/redes sociales">Investigacion3</a> | </li>
      </ul>
    </div>
    <div class="right">
      ...
      <hr />
      <h2>Como usarlo</h2>
     solo debes desplazarte por medio de los enlaces en la misma para ver nuestra informacion
      <hr />
      <h2>Enlaces</h2>
     <
	  @yield('enlaces')
